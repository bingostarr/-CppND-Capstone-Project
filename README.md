...
#### Performance
The efficacy of the CNN modeled is determined by the following key performance indicators:
...
2. If any additional libraries are needed to run the project, these are indicated with cross-platform installation instructions.

3. You can submit your writeup as markdown or pdf.


4. The README indicates which project is chosen.


   * The README describes the project you have built.


5. The README also indicates the file and class structure, along with the expected behavior or output of the program.


6. The README includes information about each rubric point addressed.
